...
`,
  ...
  {
    title: "Back-end Java Contractor",
    type: "Contract",
...
`,
  },
  {
    ...
    locationType: "Hybrid",
    location: "Belconnen District, ACT",
...
`,
  },
  {
    ...
    locationType: "Remote",
    location: "Kellyville, NSW",
    applicationEmail: "careers@amazon.com",
    applicationUrl: "https://amazon.jobs",
    slug: "backend-engineer-at-amazon-2",
    salary: 140000,
    approved: true,
    description: `
**About Amazon**

Amazon is a global leader in e-commerce and cloud computing. We are looking for highly motivated and talented engineers to join our team to help build scalable backend systems and improve the customer experience.

**Job Description**

As a Backend Engineer at Amazon, you will design and develop high-performance, reliable, and scalable backend systems. You will work closely with other teams to deliver new features and improve the existing systems.
...
- Proficiency in one or more backend programming languages such as Java, Python, or Go.
- Experience with microservices architecture and RESTful APIs.
- Familiarity with database technologies such as MySQL, PostgreSQL, or DynamoDB.
...
Amazon is an equal opportunity employer. We are committed to creating a diverse and inclusive workplace.
`,
  },
  {
    ...
    slug: "frontend-developer-at-google-3",
    salary: 160000,
    approved: true,
    description: `
**About Google**

Google is a global technology leader that specializes in Internet-related services and products. We are looking for talented frontend developers to help us create innovative and user-friendly web applications.

**Job Description**

As a Frontend Developer at Google, you will work on cutting-edge web technologies and collaborate with designers, product managers, and backend engineers to create high-quality user interfaces.

**Key Responsibilities**

- Develop responsive and interactive web applications using modern frontend technologies.
...
- Proficiency in JavaScript and modern frontend frameworks such as React, Angular, or Vue.js.
...
Google is an equal opportunity employer. We value diversity and strive to create an inclusive environment for all employees.
`,
  },
  {
    ...
    locationType: "Remote",
    location: "Chatswood, NSW",
    applicationEmail: "careers@facebook.com",
    applicationUrl: "https://www.facebookcareers.com",
    slug: "data-scientist-at-facebook-4",
    salary: 170000,
    approved: true,
    description: `
**About Facebook**

Facebook is a social media and technology company that connects billions of people around the world. We are looking for data scientists who are passionate about leveraging data to drive insights and decision-making.

**Job Description**

As a Data Scientist at Facebook, you will analyze large datasets to uncover insights and help shape product strategies. You will collaborate with cross-functional teams to solve complex problems and drive business growth.

**Key Responsibilities**

- Analyze large datasets to identify trends and patterns.
- Develop and implement data models and algorithms.
- Collaborate with product and engineering teams to drive data-driven decisions.
...
Facebook is an equal opportunity employer. We are committed to creating an inclusive and diverse workplace.
`,
  },
  ]
